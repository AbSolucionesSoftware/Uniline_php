...
<head>
    ...
    <meta name="description" content="Politicas de privacidad de UNILINE">
    <meta charset="UTF-8">
    ...
    <div class="card contenido">
        <div class="card-body">
            <div id="contenedorimg" style="margin-top: 3rem;">
                <img class="img-fluid" src="../img/image.png" alt="politicas">
            </div>
            <br>
        </div>
        <div class="">
            <div id="divparrafo1">
                <p> Gracias por unirte a nosotros, en UNILINE escuela al revés queremos
                    ...
                    Posesión de Particulares publicada en el Diario Oficial de la Federación el
                    5 de julio de 2010, pone a su disposición el presente Aviso de Privacidad
                    para informarle la forma en que recabamos, protegemos, transferimos y
                    utilizamos su información confidencial.
                    Te recordamos que puedes acceder al contenido de la Ley citada a través
                    del portal de la Cámara de Diputados del H. Congreso de la Unión
                    <a href="http://www.diputados.gob.mx.">http://www.diputados.gob.mx.</a>
                </p>

                <h5>I. DEFINICIONES</h5>
                <p>a) Derechos ARCO: derechos de Acceso, Rectificación, Cancelación y Oposición.</p>
                <p>b) Legislación Vigente Aplicable: Se refiere a la con Ley Federal de
                    Protección de Datos Particulares en Posesión de Particulares, su
                    reglamento, así como a cualquier ordenamiento jurídico que regule la
                    recabación, almacenamiento y transmisión de datos personales.</p>
                ...
                <p>e) Titular: Persona física o moral a quien corresponden los Datos
                    Personales (en adelante “Usted”).</p>
                ...
                <p>
                    ...
                    actividad o giro del negocio al que se dedique; números telefónicos fijos de
                ...
                <p>
                    1. Cumplir con las medidas establecidas por las autoridades en materia de
                    prevención de lavado de dinero y prevención de financiamiento al
                    terrorismo.
                </p>
                <p>
                    2. Realizar análisis de tendencia de consumo.
                </p>
                <p>
            ...
            <p> Las finalidades por las que UNILINE escuela al revés recaba sus Datos
                ...
                de nuestros productos y servicios, intercambiar información necesaria para
                atender auditorías internas, externas y por autoridades, así como para
                fines mercadotécnicos, publicitarios y/o de prospección comercial y para
            ...
            <p>a) Otras personas que trabajan con y para UNILINE escuela al revés.
                ...
                cabo tareas en representación nuestra y de conformidad con esta Política
                de privacidad. La forma en que procesen tu información según nuestras
                instrucciones será nuestra responsabilidad.</p>

            <p>
                b) Fuerzas del orden público y el interés público. Podremos divulgar su
                información ante terceros si determinamos que ello es razonablemente
                necesario para: (a) cumplir las leyes aplicables, las regulaciones, los
                procesos legales o las solicitudes apropiadas del gobierno; (b) proteger a
                una persona contra la muerte o lesiones graves;
            </p>
            ...
            <p> 3. Domicilio de Titular o dirección de correo electrónico para comunicar
                respuesta a
                solicitud.</p>
            <p> 4. Documentos que acrediten identidad o personalidad para presentar la
                solicitud (INE,
                Pasaporte, Poder Notarial, etc.)</p>

            <h5> VII. MEDIOS PARA EJERCER LOS DERECHOS DE ACCESO,
                RECTIFICACIÓN,
            ...
            <p>
                ...
                información personal de acuerdo con lo solicitado por el titular en los
                registros, archivos, bases de datos o tratamientos realizados por el
                responsable, previo bloqueo.
            ...
            <p> Para responder a su solicitud UNILINE escuela al revés tendrá un plazo de
                ...
                haya comunicado la respuesta anterior. Estos plazos podrán ser ampliados
                por una sola vez y por un periodo igual, cuando las circunstancias del caso
            ...
            <p>Nuestro Sitio Web utiliza cookies, web beacons y otras tecnologías a
                través de las cuales es posible monitorear su comportamiento como
                usuario de Internet, brindarle un mejor servicio y experiencia de usuario al
                navegar en el Sitio Web, así como ofrecerle nuevos productos y servicios
                basados en sus preferencias.</p>

            <p> Usted podrá deshabilitar el uso de estos mecanismos siguiendo el
                procedimiento de desactivación, determinado para cada navegador.</p>
            ...
            <h5>X. MODIFICACIONES AL AVISO DE PRIVACIDAD Y MEDIOS DE
                DIFUSIÓN</h5>

            <p> Nos reservamos el derecho de efectuar en cualquier momento
                ...
                productos. Estas modificaciones estarán disponibles al público a través de
                los siguientes medios: En nuestro Sitio Web y mediante su correo
                electrónico.</p>
            ...
            <p>
                ...
                Datos en otras ubicaciones de todo el mundo (también fuera de tu país).
                La información también podrá almacenarse de forma local en los
                dispositivos que usas para acceder a los Servicios con la garantía de
                seguridad señalada en el párrafo anterior.
            </p>
            ...
            <p> En la mayoría de nuestros cursos se deberá de realizar un pago para
                poder obtener acceso a ellos, si el usuario realiza compras, recopilamos
                algunos datos sobre las compras (como el nombre y el código postal del
                usuario), según sea necesario para procesar el pedido. El usuario debe
            ...
            <p> UNILINE escuela al revés se reserva el derecho de cambiar sus tarifas o
                ...
                tener cambios, como no poder seguir tomando un curso de manera
                gratuita hasta no realizar el pago correspondiente.</p>
            <h5> XVI. USO CORRECTO DEL SITIO WEB</h5>
            <p> El Usuario se compromete a utilizar el Sitio Web de conformidad con lo
                ...
                exhaustivo, el Usuario se abstendrá de:</p>
            <p>a. Abusar, acosar, amenazar, suplantar o intimidar a cualquier persona.</p>
            <p>b. Publicar o transmitir cualquier tipo de contenido difamatorio, obsceno,
                pornográfico, abusivo, ofensivo, profano o que infrinja derecho de autor o
            ...
            <p>d. Publicar contenidos de los cuales no posea los derechos de autor.</p>
            <p>g. Vender o transferir su perfil.</p>
            <p>h. Utilizar el Sitio Web para fines comerciales o para el beneficio de
                terceros de manera que infrinja lo establecido en el presente documento.</p>
            <p>i. Manipular cualquier paquete TCP/IP, encabezado (header) o cualquier
                ...
                enviar información falsa, alterada o que no permita identificar la fuente
                original desde donde se envió.</p>
            <p> j. Intentar descifrar, descompilar o aplicar ingeniería en reversa a cualquier
                programa de software proveedor del Sitio Web.</p>

            <p>Al compartir cualquier tipo de contenido, el Usuario declara y garantiza
                que:</p>

            <p>a. El contenido compartido no violará los derechos de propiedad.</p>
            <p>b. Si su empleador posee los derechos de cualquier propiedad intelectual
                que usted genere, ha recibido permiso de su empleador para publicar el
                contenido o ha conseguido una extensión de derechos de parte de su
                empleador.</p>
            ...
            <p> Los alumnos aceptan tomar las clases solo por motivos educacionales y
                nunca con la intención de copiar materiales o técnicas para su beneficio o
            ...
            <p> Tus datos son tratados y resguardados por UNILINE escuela al revés; si
                ...
                Departamento de Datos Personales encargado de atender y gestionar
